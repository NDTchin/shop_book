...
{{--                                <h5>Tìm kiếm</h5>--}}
{{--                            </div>--}}
{{--                            <form action="{{ route('shop-cart.search') }}" class="search-toggle-box">--}}
{{--                                <div class="input-area search-container">--}}
{{--                                    <input class="search-input" type="text" name="search_query" placeholder="Tìm kiếm tại đây">--}}
{{--                                    <button class="cmn-btn search-icon">--}}
{{--                                        <i class="far fa-search"></i>--}}
{{--                                    </button>--}}
{{--                                </div>--}}
{{--                            </form>--}}
{{--                        </div>--}}
{{--                        @if (isset($filteredCartItems) && $filteredCartItems->count() > 0)--}}
{{--                            @foreach ($filteredCartItems as $item)--}}
{{--                                <!-- Hiển thị thông tin mặt hàng -->--}}
{{--                                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">--}}
{{--                                    <div class="shop-box-items">--}}
{{--                                        <div class="book-thumb center">--}}
{{--                                            <a href="{{ route('shop-details', $item->id) }}"><img src="{{ $item->image }}" alt="img"></a>--}}
{{--                                            <ul class="shop-icon d-grid justify-content-center align-items-center">--}}
{{--                                                <li>--}}
{{--                                                    <a href="{{ route('main.shop-cart') }}"><i class="far fa-heart"></i></a>--}}
{{--                                                </li>--}}
{{--                                                <li>--}}
{{--                                                    <a href="{{ route('main.shop-cart') }}">--}}
{{--                                                        <img class="icon" src="{{ asset('assets/img/icon/shuffle.svg') }}" alt="svg-icon">--}}
{{--                                                    </a>--}}
{{--                                                </li>--}}
{{--                                                <li>--}}
{{--                                                    <a href="{{ route('shop-details', $item->id) }}"><i class="far fa-eye"></i></a>--}}
{{--                                                </li>--}}
{{--                                            </ul>--}}
{{--                                        </div>--}}
{{--                                        <div class="shop-content">--}}
{{--                                            <h3><a href="{{ route('shop-details', $item->id) }}">{{ $item->name }}</a></h3>--}}
...
{{--                            @endforeach--}}
{{--                        @else--}}
{{--                            <p>Không tìm thấy mặt hàng phù hợp.</p>--}}
{{--                        @endif--}}
                                    ...
                                    @foreach ($products as $product)
                                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                            <div class="shop-box-items">
                                                ...
                                                <div class="shop-content">
                                                    <h3><a href="{{ url('/shop-details') }}">{{ $product->name }}</a></h3>
